    ...
    return (
        <section id={"hero"}
            ...
            <div
                ...
                <h1 className={'font-normal italic font-serif'}>Hi,
                </h1>
                <h1 className={'font-normal italic font-serif text-brown-main'}> I am Ly!</h1>
            </div>
            <h1 className={'mt-[40px] text-[20px] md:text-[32px] text-center max-w-[80%]'}>I have a background in Economics and Finance. But I also code!</h1>
            <h1 className={'mt-[10px] text-[20px] md:text-[32px]'}> Welcome to my CV.</h1>
            <div>
                <button
                    className={'flex flex-col mt-[40px] text-[24px] group text-brown-main font-semibold hover:font-bold p-[10px] rounded-[10px]'}
                    onClick={scrollToNextSection}>Get to know me <img src={'/imgs/double-arrow-down-svgrepo-com.svg'}
