    ...
    return (
        <section id={"hero"}
            ...
            <div
                ...
                <TextSlide delay={350} className={'font-normal italic font-serif'}>{loc(content.greeting)}
                </TextSlide>
                <TextSlide
                    className={'font-normal italic font-serif text-brown-light/[80%] leading-relaxed'}> {loc(content.name)}</TextSlide>
            </div>
            <TextSlide delay={600}
                       className={'mt-[40px] text-[20px] md:text-[32px] text-center max-w-[80%]'}>{loc(content.tagline1)}</TextSlide>
            <TextSlide delay={1200}
                       className={'mt-[10px] text-[20px] md:text-[32px]'}>{loc(content.tagline2)}</TextSlide>
