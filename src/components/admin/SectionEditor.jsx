    ...
    experiences: {
        ...
        fields: [
            ...
            {key: 'ctaLabel', label: 'CTA label'},
            {
                ...
                label: 'Items',
                kind: 'list',
                itemDefaults: {iconKey: 'js', title: '', blurb: '', link: '', linkLabel: 'See more'},
                itemFields: [
                    {key: 'iconKey', label: 'Icon', kind: 'select', options: ['js', 'r', 'python']},
                    {key: 'title', label: 'Title'},
                    {key: 'blurb', label: 'Blurb', longText: true},
                    {key: 'link', label: 'Link (e.g. /works#frontend)'},
        ...
        fields: [
            {
                ...
                itemFields: [
                    {key: 'title', label: 'Title'},
                    {key: 'type', label: 'Type', kind: 'select', options: ['frontend', 'data']},
                    {key: 'url', label: 'URL'},
