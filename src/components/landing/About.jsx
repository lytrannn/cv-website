        ...
        <section id={"about"}
            ...
            <div className={'flex flex-col md:flex-row gap-[20px] md:gap-[50px] xl:gap-[100px]'}>
                ...
                <div className={'flex flex-col gap-[20px] md:gap-[50px] items-start my-auto'}>
                    <h1 className={'font-normal font-serif text-primary-main mx-auto md:mx-0 text-center md:text-left text-[56px]'}>{t("About me")}</h1>
                    <h1 className={' text-[20px] md:text-[24px] text-primary-main text-center md:text-left  mx-auto w-[80%] md:w-[400px] xl:w-[500px] '}>
                        {t("I am a recent graduate from Royal Melbourne Institute of Technology. I have a background in Economics and Finance. I am also a self-taught programmer. I have experience in Frontend Web Development, Data Analytics and Machine Learning.")}</h1>
                </div>
